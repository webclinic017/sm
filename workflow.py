...
def parse_arguments():
    ...
    parser.add_argument('--server', '-s', type=str, default='ai2', help='Argo Server.')
    ...
    #param_str = '{"description":{"author": "Brad Larson", "description":"Test workflow logging 6"}}'
    param_str = '{"description":{"author": "Brad Larson", "description":"Test workflow logging 6"}, "target_structure": 0.0, "batch_size": 2, "debug": "true"}'
